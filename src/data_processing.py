...
class DataProcessor:
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            logger.info(f"Users with more than 400 ratings filtered successfully")
        except Exception as e:
            logger.error(f"Error filtering users: {str(e)}")
            raise CustomException("Error filtering users",sys)
    ...
    def scale_ratings(self):
        try:
            ...
            logger.error(f"Error scaling ratings: {str(e)}")
            raise CustomException("Error scaling ratings",sys)
    ...
    def encode_data(self):
        try:
            ...
            raise CustomException("Error encoding data",sys)
    ...
    def save_artifacts(self):
        try:
            ...
            self.rating_df.to_csv(RATINF_DF,index=False)

            logger.info("Artifacts saved successfully")
        except Exception as e:
            logger.error(f"Error saving artifacts: {str(e)}")
            raise CustomException("Error saving artifacts",sys)
    ...
    def process_anime_data(self):
        try:
            ...
            logger.info("Anime and Synopsis df data processed successfully")
        except Exception as e:
            logger.error(f"Error processing anime data: {str(e)}")
            raise CustomException("Error processing anime data",sys)
