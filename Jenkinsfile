        ...
        stage("Cloning from Github...."){
            steps{
                script{
                    ...
                    checkout scmGit(branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/jothsnapraveena/Recommendation-System-MLOPS']])
                }
            }
        }
